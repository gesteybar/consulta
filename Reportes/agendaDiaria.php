	...
	<div id="divFiltroRPT">
		<table id="tblFiltroRPT">
			<tr>
				...
				<td>Emitir agendas del día:</td>
				<td colspan="6">
					<input type="date" id="txtFechaD" value="">
				</td>

				<script type="text/javascript">oMaxReg.maxcant=10000;</script>
				<td valign="top" rowspan="3"><button class="botonok" onclick="filtrar('8');">Mostrar datos</button></td>
			</tr>
			<tr>
